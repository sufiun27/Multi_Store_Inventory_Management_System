...
$replacement = filter_input(INPUT_POST, 'replacement', FILTER_VALIDATE_INT);
...
$stmt = $conn->prepare("INSERT INTO item_issue (is_po_no, is_datetime, i_id, is_qty, i_price, e_id, emp_dep, is_item_issue_by, is_avg_price, is_profit, replacement, reason)
VALUES (:item_po_no, :ad_datetime, :item_id, :quantity, :real_price, :emp_id, :emp_dep, :user, :avg_price, :profit, :replacement, :reason)");

$stmt->bindParam(':item_po_no', $item_po_no, PDO::PARAM_STR);
...
$stmt->bindParam(':replacement', $replacement, PDO::PARAM_INT);
