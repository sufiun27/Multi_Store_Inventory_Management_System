...
// Validate and sanitize item ID and update information from session
$item_main_id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
...
$stmt = $conn->prepare("UPDATE item SET i_active = :active, i_inactive_datetime = :inactive_datetime, i_inactive_by = :inactive_by WHERE i_id = :item_id");

$stmt->bindParam(':active', $active, PDO::PARAM_STR);
$stmt->bindParam(':inactive_datetime', $defaultDateTime, PDO::PARAM_STR);
$stmt->bindParam(':inactive_by', $item_update_by, PDO::PARAM_STR);
